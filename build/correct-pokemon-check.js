...
const correct_pokemon_check = (pokemon, attribute, color) => {
  if (attribute[0] === 'weight') {
    const weight = parseInt(attribute[1]); // Determines if weights match within 50 grams of the target.
    ...
    let attributeType;
    let BreakException = {}; // Determines if types match
...
var _default = correct_pokemon_check;
